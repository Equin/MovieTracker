...
public class MovieDataRepository implements MovieRepository {
    ...
    public Observable<MoviesEntity> getMovies(MovieRequestEntity movieRequestEntity) {
        return this.movieApi.getMovies(
                ...
                .doOnNext(moviesEntity -> this.movieDao.saveMovies(moviesEntity.getMovies()))
                .onExceptionResumeNext(
                        movieDao.getMoviesByOptions()
    ...
    public Observable<MovieDetailsEntity> getMovieDetails(int movieId) {
        return this.movieApi.getMovieDetailsById(movieId)
                .doOnNext(movieDetailsEntity -> movieDetailDao.saveInfo(movieDetailsEntity))
                .onExceptionResumeNext(movieDetailDao.getMovieInfo(movieId));
    }
